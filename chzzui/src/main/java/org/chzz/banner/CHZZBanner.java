...
import org.chzz.R;
import org.chzz.banner.transformer.CHZZPageTransformer;
...
public class CHZZBanner extends RelativeLayout implements CHZZViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void initView(Context context) {
        ...
        if (mPlaceholderDrawableResId != NO_PLACEHOLDER_DRAWABLE) {
            mPlaceholderIv = CHZZBannerUtil.getItemImageView(context, mPlaceholderDrawableResId);
    ...
    private void initViewPager() {
        ...
        mViewPager.setOverScrollMode(mOverScrollMode);
        mViewPager.setAllowUserScrollable(mAllowUserScrollable);
        mViewPager.setPageTransformer(true, CHZZPageTransformer.getPageTransformer(mTransitionEffect));
            ...
            if (mOnItemClickListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        mOnItemClickListener.onBannerItemClick(CHZZBanner.this, view, mModels == null ? null : mModels.get(finalPosition), finalPosition);
                    }
                });
            }
    ...
    public interface OnItemClickListener {
        void onBannerItemClick(CHZZBanner banner, View view, Object model, int position);
    }

    public interface Adapter {
        void fillBannerItem(CHZZBanner banner, View view, Object model, int position);
    }
}