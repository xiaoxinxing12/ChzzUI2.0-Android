 ...
 * 描述:
 */
public abstract class CHZZPageTransformer implements ViewPager.PageTransformer {
    ...
    public static CHZZPageTransformer getPageTransformer(TransitionEffect effect) {
        switch (effect) {
            case Default:
