...
//    private boolean mFullscreenEnabled = false;
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.video_player_controller, this);
    ...
    public void reset() {
        ...
        mTurnButton.setImageResource(R.mipmap.chzz_player_player_btn);
    ...
    private void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.mipmap.chzz_stop_btn);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.mipmap.chzz_player_player_btn);
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            mScaleButton.setImageResource(R.mipmap.chzz_star_zoom_in);
        } else {
            mScaleButton.setImageResource(R.mipmap.chzz_player_scale_btn);
        }
    }
